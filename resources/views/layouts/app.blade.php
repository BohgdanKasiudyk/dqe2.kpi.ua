        ...
        <div class="bg-image" style="background-image: url('{{ asset('media/various/bg_side_overlay_header.jpg') }}');">
            <div class="bg-primary-op">
                <div class="content-header">
                    ...
                    <!-- User Info -->
                    <div class="ms-2">
                        <a class="text-white fw-semibold" href="javascript:void(0)">Kasiudyk Bohdan</a>
        ...
        <div class="js-sidebar-scroll">
            ...
            <div class="content-side content-side-full">
                ...
                <ul class="nav-main">
                    ...
                    <li class="nav-main-heading">Внутрішня акредитація</li>
                    <li class="nav-main-item">
                        <a class="nav-main-link{{ request()->is('department') ? ' active' : '' }}" href="/department">
                            <i class="nav-main-link-icon fa fa-location-arrow"></i>
                            <span class="nav-main-link-name">Кафедри</span>
                            <span class="nav-main-link-badge badge rounded-pill bg-primary">5</span>
                        </a>
                    </li>
                    <li class="nav-main-item{{ request()->is('indicators/*') ? ' open' : '' }}">
                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" href="#">
                            <i class="nav-main-link-icon fa fa-lightbulb"></i>
                            <span class="nav-main-link-name">Показники</span>
                        </a>
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('category') ? ' active' : '' }}" href="/category">
                                    <span class="nav-main-link-name">Категорії політики</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('indicators') ? ' active' : '' }}" href="/indicator">
                                    <span class="nav-main-link-name">Індикатори</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('dataset') ? ' active' : '' }}" href="/dataset">
                                    <span class="nav-main-link-name">Набори даних</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('rebuild') ? ' active' : '' }}" href="/rebuild">
                                    <span class="nav-main-link-name">Перебудувати показники</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link" href="/registration">
                            <i class="nav-main-link-icon fa fa-location-arrow""></i>
                            <span class="nav-main-link-name">Зареєструвати нового адміністратора</span>
                        </a>
                    </li>
                </ul>
            </div>
