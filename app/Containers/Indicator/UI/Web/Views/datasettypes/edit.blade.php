...
/* @var $indicator App\Containers\Indicator\Models\Indicator */
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 space-y-2">
                            <div class="col-12">
                                ...
                                <input name="DataSet[name]" value="{{$dataset->name}}"  class="form-control" type="text" placeholder="">
                                <input type="hidden" name="DataSet[indicator_id]" value="{{$indicator->id}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <p class="text-muted">
                        ...
                        <div class="col-lg-8 space-y-2">
                            <div class="col-12">
                                ...
                                <input name="DataSet[max_value]" value="{{$dataset->max_value}}"  class="form-control" type="text" placeholder="">
                        ...
                        <div class="col-lg-8 space-y-2">
                            <div class="col-12">
                                ...
                                <input name="DataSet[coefficient]" value="{{$dataset->coefficient}}"  class="form-control" type="text" placeholder="">
