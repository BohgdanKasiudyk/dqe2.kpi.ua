...
/* @var $categories App\Containers\Indicator\Models\Category*/
...
@section('content')
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Створити новий індикатор</h1>
    ...
    <div class="content">
        ...
        <form class="row g-3 align-items-center" method="post" action="/indicator/store">
            @if ($errors->any())
            ...
            @endif
        <form class="row g-3 align-items-center" method="post" action="store">
            @csrf
                ...
                <div class="block-content py-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 space-y-2">
                            <div class="col-12">
                                <label class="visually-hidden" for="example-if-email">Email</label>
                                <input name="indicator[name]" value="" class="form-control" type="text" placeholder="">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <p class="text-muted">
                        ...
                        <div class="col-lg-8 space-y-2">
                            <div class="col-12">
                                <label class="visually-hidden" for="example-if-email">Email</label>
                                <input name="indicator[coefficient]" value=""  class="form-control" type="text" placeholder="">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <p class="text-muted">
                        ...
                        <div class="col-lg-8 space-y-2">
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    ...
                                    <input name="indicator[graduating]" class="form-check-input" type="checkbox" value="1" id="dm-post-edit-active" >
