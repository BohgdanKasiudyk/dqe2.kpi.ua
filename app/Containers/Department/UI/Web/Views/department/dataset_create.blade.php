...
/* @var $datasets App\Containers\Indicator\Models\DatasetTypes */
...
@section('content')
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Додати набір даних для {{$department->name}}</h1>
    ...
    <div class="content">
        ...
        <form class="row g-3 align-items-center" method="post" action="/department/{{$department->id}}/dataset/store">
            @if ($errors->any())
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <a class="btn btn-alt-primary" href="/department/{{$department->id}}/dataset">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 space-y-2">
                            <div class="col-12">
                                ...
                                <select name="departmentDataSet[dataset_id]" class="form-select">
                        ...
                        <div class="col-lg-8 space-y-2">
                            <div class="col-12">
                                ...
                                <input type="hidden" name="departmentDataSet[department_id]" value="{{$department->id}}">
