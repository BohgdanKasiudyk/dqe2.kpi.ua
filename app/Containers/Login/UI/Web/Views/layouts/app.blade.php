...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6/admin-template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Feb 2019 12:23:45 GMT -->
<head>
    <!-- Title -->
    ...
    <link rel="stylesheet" href="/admin/assets/vendor/hs-admin-icons/hs-admin-icons.css">

    <link rel="stylesheet" href="/assets/vendor/animate.css">
    <link rel="stylesheet" href="/assets/vendor/malihu-scrollbar/jquery.mCustomScrollbar.min.css">

    <link rel="stylesheet" href="assets/vendor/flatpickr/dist/css/flatpickr.min.css">
    <link rel="stylesheet" href="/admin/assets/vendor/bootstrap-select/css/bootstrap-select.min.css">

    <link rel="stylesheet" href="/adminassets/vendor/chartist-js/chartist.min.css">
    <link rel="stylesheet" href="/adminassets/vendor/chartist-js-tooltip/chartist-plugin-tooltip.css">
        ...
        <nav class="navbar no-gutters g-pa-0">
            ...
            <form id="searchMenu" class="u-header--search col-sm g-py-12 g-ml-15--sm g-ml-20--md g-mr-10--sm" aria-labelledby="searchInvoker" action="#!">
                <div class="input-group g-max-width-450">
                    <input class="form-control h-100 form-control-md g-rounded-4" type="text" placeholder="Enter search keywords">
